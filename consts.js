...
export const PADDING = 0.3 // its confirmed padding is an optimization now. 3 scale with 3 padding is 44 fps and 3 scale with 0 padding is 35 fps in browser test. in server test from 58 fps to 120 fps with 100,000 dynamic bodies with 1 scale and 0.25 padding
