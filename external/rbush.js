...
export default class RBush {
    ...
    // whereas search() returns an array, this just returns true or false if you are intersecting even one thing. might be faster than search(), if i have any use for it
    collides(bbox) {
        let node = this.data;
